# Puzzle
**Staircases** https://www.codingame.com/training/hard/staircases/solution

# Goal
Given N bricks, your program needs to find the number of different staircases that can be built using all of these bricks.

A staircase consists of steps of different sizes in a strictly increasing order. Two steps can not have the same height.   
Every staircase has a minimum of 2 steps and each step has at least 1 brick.
