# Puzzle
**NATO-alphabet's odd uncles** https://www.codingame.com/training/easy/nato-alphabets-odd-uncles
...
~ if it's already in the newest version, to degrade it to the oldest version  
