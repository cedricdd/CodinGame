# Puzzle
**Text alignment** https://www.codingame.com/training/medium/text-alignment
...
* JUSTIFY: spread the remaining space evenly between words of the line so that all lines end on the same column, with the exception that lines with a single word should remain left-aligned. 
