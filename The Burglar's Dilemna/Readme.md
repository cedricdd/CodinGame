# Puzzle
**The Burglar's Dilemna** https://www.codingame.com/training/hard/the-burglars-dilemna
...
This means that 1, 2, and the last 5 are correct. Since the 4 of the first line is associated with a CLUCK and 4 is next to 5, we know that CLUCK has the adjacent meaning, and CLACK the failed meaning. From this, onsidering the 3rd number, we know that 3 is a bad number, and 4 is adjacent, so the 3rd number is 5.  
